                ...
                <div className="mb-4">
                  ...
                  <div className="space-y-1.5 text-xs">
                    {([
                      ...
                      ['T1 2.0ATR (50%)', '₹' + selectedResult.priceEngine.target5.toFixed(2) + (() => { const r = selectedResult.priceEngine; const rps = r.plannedEntry - r.tacticalStop; return rps > 0 ? ` (${((r.target5 - r.plannedEntry) / rps).toFixed(1)}R)` : ''; })()],
                      ['T2 2.5ATR (30%)', '₹' + selectedResult.priceEngine.target7.toFixed(2) + (() => { const r = selectedResult.priceEngine; const rps = r.plannedEntry - r.tacticalStop; return rps > 0 ? ` (${((r.target7 - r.plannedEntry) / rps).toFixed(1)}R)` : ''; })()],
                      ['T3 4.0ATR (20%)', '₹' + selectedResult.priceEngine.target10.toFixed(2) + (() => { const r = selectedResult.priceEngine; const rps = r.plannedEntry - r.tacticalStop; return rps > 0 ? ` (${((r.target10 - r.plannedEntry) / rps).toFixed(1)}R)` : ''; })()],
