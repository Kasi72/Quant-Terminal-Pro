...
const COLUMNS: ColDef[] = [
  ...
  { key: 'statsScore', label: 'Stats', width: 55, align: 'right',
    headerTipHtml: '<div class="rt-hdr">Stats Composite Score (0-100)</div><div class="rt-row"><div><span class="rt-badge bg-cyan">What</span></div><div><div class="rt-desc">Composite of Hurst exponent, Bollinger squeeze, volume Z-score, TTM state, and inside bars. Higher = more statistical evidence for a breakout.</div></div></div><div class="rt-row"><div><span class="rt-badge bg-neon">60+</span></div><div><div class="rt-desc">Strong statistical setup — multiple indicators aligned.</div></div></div><div class="rt-row"><div><span class="rt-badge bg-yellow">30-59</span></div><div><div class="rt-desc">Moderate — some indicators support breakout.</div></div></div><div class="rt-row"><div><span class="rt-badge bg-slate">&lt;30</span></div><div><div class="rt-desc">Weak statistical evidence — limited indicator support.</div></div></div>',
  ...
  { key: 'hurst', label: 'Hurst', width: 50, align: 'right',
    headerTipHtml: '<div class="rt-hdr">Hurst Exponent (20-day)</div><div class="rt-row"><div><span class="rt-badge bg-cyan">What</span></div><div><div class="rt-desc">Measures whether price movements are trending (persistent) or mean-reverting. Fractal analysis of price structure.</div></div></div><div class="rt-row"><div><span class="rt-badge bg-neon">&gt;0.55</span></div><div><div class="rt-desc">Trending — price moves persist. Breakouts are more likely to continue. Best for momentum trades.</div></div></div><div class="rt-row"><div><span class="rt-badge bg-yellow">0.45-0.55</span></div><div><div class="rt-desc">Random walk — no clear bias. Could go either way.</div></div></div><div class="rt-row"><div><span class="rt-badge bg-orange">&lt;0.45</span></div><div><div class="rt-desc">Mean-reverting — moves tend to reverse. Breakouts may fail and snap back.</div></div></div>',
  ...
  { key: 'rsi14', label: 'RSI14', width: 50, align: 'right',
    headerTipHtml: '<div class="rt-hdr">Relative Strength Index (14-day)</div><div class="rt-row"><div><span class="rt-badge bg-cyan">What</span></div><div><div class="rt-desc">Classic momentum oscillator. Measures speed and magnitude of price changes over 14 days.</div></div></div><div class="rt-row"><div><span class="rt-badge bg-neon">55-70</span></div><div><div class="rt-desc">Bullish momentum — ideal breakout zone. Strong but not overbought.</div></div></div><div class="rt-row"><div><span class="rt-badge bg-orange">&gt;70</span></div><div><div class="rt-desc">Overbought — momentum may be exhausting. Late entry risk.</div></div></div><div class="rt-row"><div><span class="rt-badge bg-yellow">45-55</span></div><div><div class="rt-desc">Neutral — no strong momentum either way.</div></div></div><div class="rt-row"><div><span class="rt-badge bg-red">&lt;30</span></div><div><div class="rt-desc">Oversold — possible reversal bounce. Not a breakout setup.</div></div></div>',
  ...
  { key: 'cci34', label: 'CCI34', width: 55, align: 'right',
    headerTipHtml: '<div class="rt-hdr">Commodity Channel Index (34-day)</div><div class="rt-row"><div><span class="rt-badge bg-cyan">What</span></div><div><div class="rt-desc">Measures price deviation from its statistical mean. Identifies trend strength and potential reversals.</div></div></div><div class="rt-row"><div><span class="rt-badge bg-neon">&gt;100</span></div><div><div class="rt-desc">Strong bullish — price significantly above mean. Trend confirmed. Momentum breakout territory.</div></div></div><div class="rt-row"><div><span class="rt-badge bg-yellow">0 to 100</span></div><div><div class="rt-desc">Mild bullish — above mean but not extreme. Building momentum.</div></div></div><div class="rt-row"><div><span class="rt-badge bg-orange">0 to -100</span></div><div><div class="rt-desc">Mild bearish — below mean. Pullback or early reversal.</div></div></div><div class="rt-row"><div><span class="rt-badge bg-red">&lt;-100</span></div><div><div class="rt-desc">Strong bearish — deeply below mean. Possible capitulation or deep trend.</div></div></div>',
  ...
  { key: 'sharpe', label: 'Sharpe', width: 55, align: 'right',
    headerTipHtml: '<div class="rt-hdr">Sharpe Ratio (20-day)</div><div class="rt-row"><div><span class="rt-badge bg-cyan">What</span></div><div><div class="rt-desc">Risk-adjusted return: average daily return ÷ standard deviation of returns × √252. Higher = better return per unit of risk.</div></div></div><div class="rt-row"><div><span class="rt-badge bg-neon">&gt;2.0</span></div><div><div class="rt-desc">Excellent — very high risk-adjusted returns. Institutional-quality momentum.</div></div></div><div class="rt-row"><div><span class="rt-badge bg-emerald">1.0-2.0</span></div><div><div class="rt-desc">Good — positive returns with manageable volatility.</div></div></div><div class="rt-row"><div><span class="rt-badge bg-yellow">0-1.0</span></div><div><div class="rt-desc">Marginal — returns barely compensate for the risk taken.</div></div></div><div class="rt-row"><div><span class="rt-badge bg-orange">&lt;0</span></div><div><div class="rt-desc">Negative — losing money on a risk-adjusted basis. Avoid.</div></div></div>',
  ...
  { key: 'insBar', label: 'InsBr', width: 45, align: 'right',
    headerTipHtml: '<div class="rt-hdr">Inside Bars (consecutive)</div><div class="rt-row"><div><span class="rt-badge bg-cyan">What</span></div><div><div class="rt-desc">Count of consecutive inside bars (each bar\'s high/low within the previous bar\'s range). Maximum compression indicator — energy coiling.</div></div></div><div class="rt-row"><div><span class="rt-badge bg-neon">≥3</span></div><div><div class="rt-desc">Extreme compression — 3+ bars inside each other. Rare. Explosive breakout expected.</div></div></div><div class="rt-row"><div><span class="rt-badge bg-emerald">2</span></div><div><div class="rt-desc">Strong compression — double inside bar. Significant energy buildup.</div></div></div><div class="rt-row"><div><span class="rt-badge bg-slate">0-1</span></div><div><div class="rt-desc">Normal — no unusual compression pattern.</div></div></div>',
