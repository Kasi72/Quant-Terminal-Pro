...
export const PARAM_SETS: Record<ParamSetKey, ParamSet> = {
  ...
  optimized_elite_10plus: {
    name: 'Elite v8-DT 10+', tag: 'Quality-first',
    ...
    minExactVolRatio20: 1.60, minExactVolVsPre5: 2.00,
    minCloseLoc: 75, maxUpperWickPct: 35, minBodyPct: 25, maxCandleRisk: 8.5,
    minUltraPrecisionScore: 25, minRSI2: 50,
    minVolatilityExpansionRatio: 1.25, minCandleQualityScore: 2,
    maxCloseAboveZonePct: null,
  },
  optimized_ultraselective_8plus: {
    name: 'Ultra-Selective v8-DT 8+', tag: 'Ultra-Selective',
    ...
    minExactVolRatio20: 1.60, minExactVolVsPre5: 3.50,
