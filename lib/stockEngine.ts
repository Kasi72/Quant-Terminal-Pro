...
export const PARAM_SETS: Record<ParamSetKey, ParamSet> = {
  ...
  optimized_ultraselective_8plus: {
    ...
    minExactVolRatio20: 1.20, minExactVolVsPre5: 2.00,
    minCloseLoc: 65, maxUpperWickPct: 40, minBodyPct: 25, maxCandleRisk: 8.5,
    minUltraPrecisionScore: 45, minRSI2: 55,
    minVolatilityExpansionRatio: 1.50, minCandleQualityScore: null,
    maxCloseAboveZonePct: null,
  },
};
