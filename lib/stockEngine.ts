...
export const PARAM_SETS: Record<ParamSetKey, ParamSet> = {
  ...
  optimized_highprecision_15plus: {
    name: 'HighPrecision v7-UT 15+', tag: 'Balanced',
    minAvgTurnover20: 10_000_000, maxATRPct14Pctl120: 85,
    maxPre10AvgRangeATR: 0.80, maxPre10ExpansionCount: 3, expansionATRMultiplier: 1.1,
    zoneRangeATRThreshold: 1.0, minZoneLen: 4, maxZoneLen: 25, maxZoneTightnessPct: 18.0,
    ...
    minCloseLoc: 50, maxUpperWickPct: 40, minBodyPct: 30, maxCandleRisk: 13.0,
  ...
  optimized_ultraselective_8plus: {
    name: 'Ultra-Selective v7-UT 8+', tag: 'Ultra-Selective',
    minAvgTurnover20: 10_000_000, maxATRPct14Pctl120: 95,
    maxPre10AvgRangeATR: 0.80, maxPre10ExpansionCount: 2, expansionATRMultiplier: 1.1,
    zoneRangeATRThreshold: 0.9, minZoneLen: 4, maxZoneLen: 25, maxZoneTightnessPct: 8.0,
    maxPre10AvgVolRatio: 0.90, maxPre5AvgVolRatio: 0.95,
    maxPre10HighVolCount: 4, highVolMultiplier: 1.5, maxPre10RedVolBias: 2.00,
    breakoutMultiplier: 1.001,
    minExactRangeATR14: 1.4, maxExactRangeATR14: 6.0,
    minExactVolRatio20: 1.60, minExactVolVsPre5: 3.00,
    minCloseLoc: 70, maxUpperWickPct: 30, minBodyPct: 40, maxCandleRisk: 8.5,
