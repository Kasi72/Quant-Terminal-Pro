...
export const PARAM_SETS: Record<ParamSetKey, ParamSet> = {
  optimized_deployable_20plus: {
    name: 'Deployable v9-80 20+', tag: '★ 96% WR',
  ...
  optimized_highprecision_15plus: {
    name: 'HighPrecision v9-80 15+', tag: '85% WR',
  ...
  optimized_elite_10plus: {
    name: 'Elite v9-80 10+', tag: '100% WR',
    minAvgTurnover20: 20_000_000, maxATRPct14Pctl120: 40,
    maxPre10AvgRangeATR: 0.90, maxPre10ExpansionCount: 3, expansionATRMultiplier: 1.1,
    zoneRangeATRThreshold: 0.95, minZoneLen: 7, maxZoneLen: 25, maxZoneTightnessPct: 5.0,
  ...
  optimized_ultraselective_8plus: {
    name: 'Ultra-Selective v9-80 8+', tag: '100% WR',
