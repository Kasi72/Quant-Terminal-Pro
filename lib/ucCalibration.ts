...
// Generated: 2026-08-07, n_train=3510, Brier=0.1877, AUC=0.6128
// Platt sigmoid: blended ucScore (0-100) -> P(hit_uc_proxy)%

export const UC_PLATT_COEF      = 0.029862;
export const UC_PLATT_INTERCEPT = -2.268722;
export const UC_CALIBRATION_META = {
  ...
  n_train:    3510,
  val_brier:  0.1877 as number | null,
};
